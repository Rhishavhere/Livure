  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="bg-white w-44 h-44 rounded-full absolute -right-8 -bottom-12">

        <Link href="/">
          <Image src="right.svg" width={50} height={50} className="absolute right-16 top-12 rotate-180 "></Image>
        </Link>
      </motion.div>
